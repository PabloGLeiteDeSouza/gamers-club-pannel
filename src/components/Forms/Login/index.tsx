...
const FormLogin = () => {
  return (
    <div className="bg-primary-content px-8 py-8 rounded-lg" >
        <div className="w-full  flex justify-center my-5 text-2xl" >
                    ...
                    <form className="flex flex-col gap-5" onSubmit={handleSubmit} action="">
                        ...
                        <label className="form-control w-full">
                            ...
                            <label className="input input-bordered flex items-center gap-2">
                                ...
                                <input value={values.senha} onChange={handleChange('senha')} type="password" className="grow" placeholder="************" />
                            </label>
                            <div className="label">
                                <span className={`label-text-alt ${errors.login ? "text-error" :  ""}`}>{errors.login ? errors.login : "O login e seu email ou sua senha"}</span>
                                <span className="label-text-alt"></span>
                        ...
                        <div className="my-3.5" >
                            <span className="text-sm" >Ainda nao e registrado(a) <Link className="link" href="/registro" >clique aqui</Link> para se registrar.</span>
                        </div>
                        <div className="" >
